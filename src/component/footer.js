  ...
  return (
    <>
             ...
             <div className='help_blog'>
	            	...
	            	<div className='help_sec_right'>
		                ...
		                <div className='email_support'>
		                    ...
		                    <div className='email_support_blog'>
		                       <h6>For Vendors</h6>
		                        <a href="mailto:sales@kioskweb.com">sales@kioskweb.com</a> 
		                    </div>
		                </div>
	            	</div>
        		</div>
                ...
                <div className="footer-top">
                    <div className="row">
                        <div className="col-lg-6 col-md-4 col-sm-6 col-6">
                            ...
                            <a class="navbar-brand" href="#">KIO$KWEB</a>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-8 col-sm-6 col-6">
                            ...
                            <div className="footer_widget">
                                ...
                                <ul>
                                    ...
                                    <form action="/action_page.php">
                                        <input type="email" id="emails" name="emails" multiple="" placeholder="Email"/>
        ...
        <div className="copyright text-center">
	        <p>Copyright © 2022 <a href="#">Kioskweb. </a> All rights reserved</p>
	    </div>
    </>
  )
}
